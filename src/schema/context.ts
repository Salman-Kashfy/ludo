...
import TournamentMatchPlayerModel from './tournament-match-player/model';
...
export default class Context {
    ...
    tournamentMatchPlayer: TournamentMatchPlayerModel;
    table: TableModel;
    shift: ShiftModel;
    ...
    constructor(connection: any, schema: any, req?: any, user?: any) {
        ...
        this.tournamentMatchPlayer = new TournamentMatchPlayerModel(connection, this);
